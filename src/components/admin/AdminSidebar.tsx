...
export const AdminSidebar: React.FC<AdminSidebarProps> = ({
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed lg:static inset-y-0 left-0 z-40 w-72 sm:w-80 bg-slate-900 text-slate-100 border-r border-slate-800 flex flex-col justify-between transition-transform duration-300 ease-in-out shadow-2xl lg:shadow-none shrink-0
      ...
      >
        ...
        <div className="p-4 bg-slate-950/90 border-b border-slate-800">
          ...
          <div className="mt-3.5 relative">
            ...
            <input
              ...
              className="w-full pl-8 pr-7 py-2 bg-slate-900/90 border border-slate-700/80 rounded-xl text-xs text-slate-100 placeholder-slate-500 focus:outline-hidden focus:border-amber-400 focus:ring-1 focus:ring-amber-400 transition-all"
            />
            {searchQuery && (
              <button
              ...
              {searchResults.map((res, i) => {
                ...
                return (
                  <button
                    ...
                    className="w-full flex items-center justify-between p-3 rounded-2xl bg-slate-800/80 hover:bg-amber-500 hover:text-slate-950 text-slate-200 text-left transition-all group cursor-pointer"
                  >
              ...
              {hubs.map((hub) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center justify-between p-3 rounded-2xl text-left transition-all cursor-pointer group relative ${
                      isSelected
        ...
        <div className="p-3 bg-slate-950/80 border-t border-slate-800 space-y-2">
          <div className="px-2 py-1.5 rounded-xl bg-slate-900/90 border border-slate-800/80 flex items-center justify-between text-[10px] text-slate-400">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-2 px-3 rounded-xl bg-rose-500/10 hover:bg-rose-500/20 text-rose-300 hover:text-rose-200 border border-rose-500/20 text-xs font-bold transition-all cursor-pointer"
          >
