  ...
  return (
    <div className="min-h-screen w-full max-w-full overflow-x-hidden bg-slate-100 flex flex-col selection:bg-amber-500 selection:text-slate-950">
        ...
        <div className="flex items-center gap-2 sm:gap-3 min-w-0">
          ...
          {(tabHistory.length > 0 || currentActiveTab !== 'dashboard') && (
            <button
              ...
              className="min-h-[44px] flex items-center justify-center gap-1.5 px-3 sm:px-3.5 py-2 rounded-xl bg-slate-800 hover:bg-amber-500 hover:text-slate-950 active:bg-amber-400 text-amber-300 border border-slate-700 hover:border-amber-400 text-xs font-black transition-all shadow-sm cursor-pointer shrink-0 group touch-manipulation active:scale-95"
          ...
          <div className="flex items-center gap-3 min-w-0">
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-2xl bg-gradient-to-br from-amber-400 via-orange-500 to-amber-600 flex items-center justify-center font-black text-slate-950 text-sm shadow-md shrink-0 border border-amber-300/30">
              <Building2 className="w-5 h-5 sm:w-6 sm:h-6 text-slate-950" />
            </div>
            
            <div className="min-w-0">
              <div className="flex items-center gap-2">
                <span className="font-black text-xs sm:text-sm text-white truncate max-w-[170px] sm:max-w-xs md:max-w-md">
                  {settings.schoolName}
                </span>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* Content Canvas */}
        <main className="flex-1 overflow-y-auto px-3.5 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8 custom-scrollbar w-full max-w-full overflow-x-hidden">
            ...
            {currentActiveTab !== 'dashboard' && (
              <div className="mb-6 flex flex-wrap items-center justify-between gap-3 bg-white p-3 sm:p-4 rounded-2xl border border-slate-200 shadow-xs">
                <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
                  <button
                    onClick={handleGoBackTab}
                    className="min-h-[44px] flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-slate-900 hover:bg-amber-500 hover:text-slate-950 active:bg-amber-400 text-white text-xs font-black transition-all shadow-xs cursor-pointer group shrink-0 touch-manipulation active:scale-95"
                  ...
                  <div className="flex items-center gap-1.5 text-xs text-slate-500 font-medium truncate">
                    <button 
                      ...
                      className="min-h-[40px] px-2 py-1 hover:text-amber-600 active:text-amber-700 font-bold flex items-center gap-1.5 transition-colors cursor-pointer touch-manipulation rounded-lg hover:bg-slate-50"
                    >
                    ...
                    <span className="font-extrabold text-slate-900 bg-amber-50 px-2.5 py-1.5 rounded-lg border border-amber-200/60 inline-flex items-center">
                      {language === 'hi' ? activeTabInfo.titleHi : activeTabInfo.titleEn}
                    </span>
                  </div>
                </div>
                ...
                <button
                  onClick={() => handleTabChange('dashboard')}
                  className="min-h-[44px] text-xs font-bold text-slate-700 hover:text-amber-800 bg-slate-100 hover:bg-amber-50 active:bg-amber-100 px-3.5 py-2 rounded-xl border border-slate-200 hover:border-amber-200 transition-all flex items-center justify-center gap-2 cursor-pointer ml-auto touch-manipulation active:scale-95"
                >
